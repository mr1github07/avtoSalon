        ...
        <div>
            ...
            <center><div className="form">
                <div className="all-button">
                    <button style={data === 1 ? { background: '#ff4605', border: '1px solid gray;' } : { background: 'white' }} onClick={() => { setData(1) }}>Login</button>
                    <button style={data === 2 ? { background: '#ff4605', border: '10px solid gray ;' } : { background: 'white' }} onClick={() => { setData(2) }}>Register</button>
                </div>
